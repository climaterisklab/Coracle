...
#### load data ####
mermaid_data <- read.csv("Final_Relevant_Scripts/MermaidBleachingData_WithDHW.csv")
...
gcbd_data <- read.csv("Final_Relevant_Scripts/All_Bleaching_Events_Data_AllDHW.csv")
